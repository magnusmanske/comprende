...
export default {
	...
	methods : {
		...
		init : function () {
			...
			var params = { action:'parse' , prop:'text|revid' , format:'json' , disabletoc:1 , disableeditsection:1 , mobileformat:1 , noimages:1 , section:me.section } ;
